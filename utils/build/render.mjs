...
function renderHomePage(model, config) {
  ...
  const body = `<section class="panel-shell home-emoji-shell" aria-label="Emoji Explorer">
    ...
    <nav class="panel-crumbs" aria-label="Explorer Breadcrumb">
      <button type="button" id="panel-home" class="crumb-home" aria-label="Back to categories">⌂</button>
      <span class="crumb-separator" aria-hidden="true">/</span>
      <span id="panel-current">⌂</span>
      <a class="home-categories-link" href="/category/" aria-label="Open category pages">↗</a>
    </nav>
